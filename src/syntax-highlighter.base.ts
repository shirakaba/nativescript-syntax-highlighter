...
export const codeProperty = new Property<SyntaxHighlighterViewBase, string>({
    name: 'code',
    defaultValue: ''
});

export const languageNameProperty = new Property<SyntaxHighlighterViewBase, string | null>({
    name: 'languageName',
    defaultValue: null
});
